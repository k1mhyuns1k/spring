		...
		<th>
			<c:choose>
				...
				<c:when test="${param.orderCond == 'title_desc' }">
					<a href="mypage.do?orderCond=title_asc">제목 v</a>
				</c:when>
				<c:otherwise>
		...
		<th>
			<c:choose>
				...
				<c:when test="${param.orderCond == 'regdate_desc' }">
					<a href="mypage.do?orderCond=regdate_asc">작성일 v</a>
				</c:when>
				<c:otherwise>
...
<br>
<!--  <input type="button" value="등록" onclick="location.href='/spring/board/write.do';"> -->
</body>
</html>