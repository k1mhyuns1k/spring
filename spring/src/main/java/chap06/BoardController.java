...
public class BoardController {
	...
	// impl로 써도 상관은 없지만, 스프링 입장에서는 타입으로 찾기 때문에 하위 클래스이기 때문에 찾아짐.
	// impl로 안쓰는 이유는, 다형성 기능을 적용하기 위해서.
	...
	public String insert(BoardVo vo, HttpServletRequest req, MultipartFile file) { //req 변수 추가해서, setAttribute
		// 파일 저장
		...
		if(r > 0) {
			...
			req.setAttribute("msg", "등록시 오류가 발생했습니다.");
...
//	public String update(BoardVo vo, HttpServletRequest req) { //req 변수 추가해서, setAttribute
...
//			req.setAttribute("url", "index.do");
//		} else {
//			req.setAttribute("msg", "수정시 오류가 발생했습니다.");
//			req.setAttribute("url", "edit.do?boardno=" + vo.getBoardno());
//		}
//		return "include/result";
//	}
