...
public class BoardController {
	...
	public String insert(BoardVo vo, HttpServletRequest req, MultipartFile file, HttpSession sess) { //req 변수 추가해서, setAttribute
		// 파일 저장
		vo.setUserno(((UserVo)sess.getAttribute("loginInfo")).getUserno());
		// 세션에서 getAttribute를 하면 Object, 이를 UserVo로 강제 형변환.
